      ...
      <header className="border-pg-gold/35 bg-pg-black border-b text-white">
        <div className="mx-auto flex max-w-7xl flex-col gap-3 px-4 py-3 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
          ...
          >
            ...
            >
              <Link href="/operacion/marketplace/configuracion">
                Activación Marketplace
              </Link>
            </Button>
            <Button
              asChild
            ...
            <Button
              ...
              className="shrink-0 text-white/75 hover:bg-white/10 hover:text-white"
            >
              <Link href="/operacion/marketplace/pagos">Pagos Partner</Link>
            </Button>
            <Button
              asChild
              variant="ghost"
              className="shrink-0 text-white/75 hover:bg-white/10 hover:text-white"
            >
              <Link href="/operacion/marketplace/payouts">Payouts</Link>
            </Button>
            <Button
              asChild
              variant="ghost"
              className="shrink-0 text-white/75 hover:bg-white/10 hover:text-white"
            >
              <Link href="/operacion/marketplace/reclamos">Reclamos</Link>
            </Button>
            <Button
              asChild
              variant="ghost"
